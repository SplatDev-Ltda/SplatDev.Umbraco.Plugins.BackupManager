...
namespace development.camtc.org.App_Code
{
    public class BackupController : UmbracoApiController
    {
       ...
       public string wwwRootPath { get; private set; }
        ...
        //    if (System.IO.File.Exists(string.Format(FilesPath, DateTime.Now.ToString(TIMESTAMP))))
        //    {
        //        System.IO.File.Delete(string.Format(FilesPath, DateTime.Now.ToString(TIMESTAMP)));
        //    }
